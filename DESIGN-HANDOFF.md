# 88779b51-78e2-4fc7-afc7-eb53c9fa6041 implementation handoff
...
- `tcg-vault-dark.html`
- `tcg-vault-final-logo.html`
- `tcg-vault-map.html`
- `tcg-vault-unified.html`
- `tcg-vault.html`
- `tournaments.html`
...
- `brand-spec.md`
- `mpc16xm6-image.png`
- `mpc1nlvk-WhatsApp-Image-2026-04-28-at-10.33.34-PM.jpeg`
- `mpc1t4cl-Diseño-sin-título.png`
